...
import argparse
"""
This is a minimal script for applying YOLO weights to a small dataset of images and generating the overlays.
...
def parse_arguments():
    ...
    parser.add_argument('--weights', dest="weights", default=r"src\models\GobyFinderGoPro.pt", help='Weights path')
