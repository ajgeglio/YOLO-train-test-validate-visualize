...
class GenerateSplits:
    ...
    def sample_df_high_n_fish(self, df, year, n_samples):
        dfsamp = df[df.year == year]
        ...
        dfsamp = dfsamp.sort_values(by="Filename")
        return dfsamp.reset_index()
    def chunk_split(self, df_list_by_year, tr_frac=0.8, va_frac=0.099, year_splits = 8, seed=42):
